...
type KNucleotide_Worker_Env interface {
	...
	SequenceResult_To_Master() knucleotide.SequenceResult
	SequenceJob_From_Master(sequencejob_msg knucleotide.SequenceJob)
}

type KNucleotideWorkerState struct {
	SeqReport string
}

func (k *KNucleotideWorkerState) Done() knucleotide_2.Worker_Result {
	return knucleotide_2.Worker_Result{}
}

func (k *KNucleotideWorkerState) SequenceResult_To_Master() knucleotide.SequenceResult {
	return knucleotide.SequenceResult{Res: k.SeqReport}
}

func (k *KNucleotideWorkerState) SequenceJob_From_Master(sequencejob_msg knucleotide.SequenceJob) {
	k.SeqReport = sequenceReport(sequencejob_msg.Dna, seqString(sequencejob_msg.Sequence))
}
