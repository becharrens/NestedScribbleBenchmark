...
import "NestedScribbleBenchmark/primesieve_base/primesieve2/channels/primesieve"
...
import "NestedScribbleBenchmark/primesieve_base/primesieve2/roles"
import "sync"
...
func Start_PrimeSieve_Worker(protocolEnv PrimeSieve_Env, wg *sync.WaitGroup, roleChannels primesieve.Worker_Chan, inviteChannels invitations.PrimeSieve_Worker_InviteChan, env callbacks.PrimeSieve_Worker_Env) {
	defer wg.Done()
	roles.PrimeSieve_Worker(wg, roleChannels, inviteChannels, env)
}
