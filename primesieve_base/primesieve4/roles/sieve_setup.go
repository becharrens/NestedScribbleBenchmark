...
func Sieve_SendCommChannels(wg *sync.WaitGroup, inviteChan invitations.Sieve_RoleSetupChan) sieve.W1_Chan {
	...
	inviteChan.M_Chan <- m_chan
	// roleChannels.W1_Chan <- w1_chan

	inviteChan.M_InviteChan <- m_inviteChan
